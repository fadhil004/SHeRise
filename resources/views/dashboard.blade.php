...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="../assets/images/logo-remove.png" />
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ route('home')}}" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">SHeRise</span>
            </a>
                    ...
                    <div class="card-body">
                      ...
                      @csrf
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name" placeholder="Masukkan Judul Acara" name="title" />
                          </div>
                        </div>
                        <div class="row mb-3">
                    ...
                    <div class="card-body">
                      ...
                      @csrf
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Judul</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name" placeholder="Masukkan Judul Materi" name="title" />
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-description" rows="5">Deskripsi</label>
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-link">Link</label>
                          <div class="col-sm-10">
                            <input
                                name="link"
                              type="text"
                              id="basic-default-link"
                              class="form-control phone-mask"
                              placeholder="Masukkan Kota/Kabupaten"
                              aria-label="658 799 8941"
                              aria-describedby="basic-default-phone"
